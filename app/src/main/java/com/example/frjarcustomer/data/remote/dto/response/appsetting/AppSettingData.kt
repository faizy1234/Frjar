...
data class AppSettingData(
    ...
    @SerializedName("delete_reason_arr") val deleteReasonArr: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.DeleteReasonItem>? = null,
    ...
    @SerializedName("social_url_arr") val socialUrlArr: com.example.frjarcustomer.data.remote.dto.response.appsetting.SocialUrlArr? = null,
    @SerializedName("is_otp") val isOtp: Boolean? = null,
    @SerializedName("hire_tech_web_img") val hireTechWebImg: String? = null,
    @SerializedName("project_banner") val projectBanner: com.example.frjarcustomer.data.remote.dto.response.appsetting.ProjectBannerDto? = null,
    @SerializedName("project_unauth_text") val projectUnauthText: com.example.frjarcustomer.data.remote.dto.response.appsetting.ProjectUnauthTextDto? = null,
    @SerializedName("project_subscription_arr") val projectSubscriptionArr: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.ProjectSubscriptionItem>? = null,
    @SerializedName("project_feature_arr") val projectFeatureArr: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.ProjectFeatureItem>? = null,
    ...
    @SerializedName("quotation_data") val quotationData: com.example.frjarcustomer.data.remote.dto.response.appsetting.QuotationDataDto? = null,
    ...
    @SerializedName("payment_gateway") val paymentGateway: com.example.frjarcustomer.data.remote.dto.response.appsetting.PaymentGatewayDto? = null,
    ...
    @SerializedName("banner") val banner: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.BannerItem>? = null,
    @SerializedName("services") val services: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.ServiceItem>? = null,
    @SerializedName("categories") val categories: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.CategoryItem>? = null,
    @SerializedName("offer_arr") val offerArr: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.OfferItem>? = null,
    @SerializedName("feature_products") val featureProducts: List<com.example.frjarcustomer.data.remote.dto.response.appsetting.FeatureProductItem>? = null,
    @SerializedName("video") val video: com.example.frjarcustomer.data.remote.dto.response.appsetting.VideoDto? = null,
